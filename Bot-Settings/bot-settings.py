...
import requests
import datetime
from config import CONSUMER_KEY, CONSUMER_SECRET, ACCESS_TOKEN, ACCESS_TOKEN_SECRET, GIPHY_API_KEY
...
def reply_with_gif(tweet_id, query):
    ...
    response = requests.get(f"https://api.giphy.com/v1/gifs/random?api_key={GIPHY_API_KEY}&tag={query}&rating=g")
